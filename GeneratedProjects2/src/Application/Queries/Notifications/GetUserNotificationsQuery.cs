...
using LogsDtoCloneTest.Application.DTOs.Notifications;
using LogsDtoCloneTest.Application.Interfaces;
using LogsDtoCloneTest.SharedKernel.BaseTypes;

namespace LogsDtoCloneTest.Application.Queries.Notifications;
...
public sealed record GetUserNotificationsQuery(string UserId, string? UserRole = null, bool? IsRead = null) : IQuery<NotificationListDto>
{
    public sealed class Handler : IQueryHandler<GetUserNotificationsQuery, NotificationListDto>
    {
        ...
        private readonly Microsoft.AspNetCore.Identity.UserManager<LogsDtoCloneTest.Domain.Entities.ApplicationUser> _userManager;

        public Handler(INotificationRepository notificationRepository, Microsoft.AspNetCore.Identity.UserManager<LogsDtoCloneTest.Domain.Entities.ApplicationUser> userManager)
        {
