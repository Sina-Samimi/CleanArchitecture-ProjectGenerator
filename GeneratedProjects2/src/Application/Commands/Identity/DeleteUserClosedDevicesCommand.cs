...
namespace LogsDtoCloneTest.Application.Commands.Identity;

public sealed record DeleteUserClosedDevicesCommand(string UserId) : ICommand<int>;

public sealed class DeleteUserClosedDevicesCommandHandler : ICommandHandler<DeleteUserClosedDevicesCommand, int>
{
    private readonly IUserSessionRepository _userSessionRepository;
    private readonly IAuditContext _auditContext;

    public DeleteUserClosedDevicesCommandHandler(
    ...
    public async Task<Result<int>> Handle(DeleteUserClosedDevicesCommand request, CancellationToken cancellationToken)
    {
