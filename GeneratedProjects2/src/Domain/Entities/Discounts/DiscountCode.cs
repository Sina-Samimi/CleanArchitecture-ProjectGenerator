...
using LogsDtoCloneTest.Domain.ValueObjects;

namespace LogsDtoCloneTest.Domain.Entities.Discounts;
...
#pragma warning restore IDE0051
    ...
    public sealed record DiscountApplicationResult(
        string Code,
        LogsDtoCloneTest.Domain.Enums.DiscountType AppliedDiscountType,
        ...
        decimal? EffectiveMaxDiscount)
    {
        ...
        public static DiscountApplicationResult CreateFailure(string message = "Discount application failed")
        {
            return new DiscountApplicationResult(
                string.Empty,
                LogsDtoCloneTest.Domain.Enums.DiscountType.Percentage,
                0m,
                0m,
                0m,
                null,
