...
using ProductCommentEntity = LogsDtoCloneTest.Domain.Entities.Catalog.ProductComment;
using ProductEntity = LogsDtoCloneTest.Domain.Entities.Catalog.Product;
