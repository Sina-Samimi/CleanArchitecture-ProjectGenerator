using System.Text;
using LogsDtoCloneTest.Application;
using LogsDtoCloneTest.Application.Interfaces;
using LogsDtoCloneTest.Infrastructure;
using LogsDtoCloneTest.Infrastructure.Persistence;
using LogsDtoCloneTest.SharedKernel.Authorization;
using LogsDtoCloneTest.WebSite.Authorization;
using LogsDtoCloneTest.WebSite.Extensions;
using LogsDtoCloneTest.WebSite.Services;
using LogsDtoCloneTest.WebSite.Services.Cart;
using LogsDtoCloneTest.WebSite.Services.Blog;
using LogsDtoCloneTest.WebSite.Services.Products;
...
try
{
    ...
    var paymentRepo = scope.ServiceProvider.GetService<LogsDtoCloneTest.Application.Interfaces.IPaymentSettingRepository>();
...
builder.Services.AddSingleton<LogsDtoCloneTest.Infrastructure.Services.Logging.AttarApplicationLogSink>();

// Add services to the container.
builder.Services.AddControllersWithViews(options =>
{
    options.Filters.Add<AdminPagePermissionFilter>();
    options.Filters.Add<LogsDtoCloneTest.WebSite.Filters.SiteNameActionFilter>();
    options.Filters.Add<LogsDtoCloneTest.WebSite.Filters.VisitTrackingActionFilter>();
    options.Filters.Add<LogsDtoCloneTest.WebSite.Filters.SeoMetadataActionFilter>();
})
...
builder.Services.AddScoped<LogsDtoCloneTest.Application.Interfaces.ISMSSenderService, HangfireApplicationSmsSender>();
builder.Services.AddScoped<AdminPagePermissionFilter>();
builder.Services.AddScoped<LogsDtoCloneTest.WebSite.Filters.SiteNameActionFilter>();
builder.Services.AddScoped<LogsDtoCloneTest.WebSite.Filters.VisitTrackingActionFilter>();
builder.Services.AddScoped<LogsDtoCloneTest.WebSite.Filters.SeoMetadataActionFilter>();
builder.Services.AddScoped<LogsDtoCloneTest.WebSite.Filters.SeoMetadataActionFilter>();
...
builder.Services.AddSingleton<IAuthorizationPolicyProvider, LogsDtoCloneTest.SharedKernel.Authorization.PermissionPolicyProvider>();
...
builder.Services.AddScoped<IAuthorizationHandler, LogsDtoCloneTest.SharedKernel.Authorization.PermissionAuthorizationHandler>();
...
{
    options.ServerName = $"LogsDtoCloneTest-WebSite-Hangfire-{Environment.MachineName}";
});
...
var customSink = app.Services.GetRequiredService<LogsDtoCloneTest.Infrastructure.Services.Logging.AttarApplicationLogSink>();
...
app.UseMiddleware<LogsDtoCloneTest.WebSite.Middleware.MaintenanceModeMiddleware>();
...
app.UseMiddleware<LogsDtoCloneTest.WebSite.Middleware.SessionValidationMiddleware>();
