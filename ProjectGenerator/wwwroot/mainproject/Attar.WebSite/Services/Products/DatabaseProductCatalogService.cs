...
using ProductCommentEntity = Attar.Domain.Entities.Catalog.ProductComment;
using ProductEntity = Attar.Domain.Entities.Catalog.Product;

namespace Attar.WebSite.Services.Products;
