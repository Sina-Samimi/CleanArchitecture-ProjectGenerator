        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastReplyDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    HasUnreadReplies = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tickets_AspNetUsers_UpdaterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketReplies_AspNetUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TicketReplies_AspNetUsers_RepliedById",
                        column: x => x.RepliedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TicketReplies_AspNetUsers_UpdaterId",
                        column: x => x.UpdaterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketReplies_CreateDate",
                table: "TicketReplies",
                column: "CreateDate");

            migrationBuilder.CreateIndex(
                name: "IX_TicketReplies_CreatorId",
                table: "TicketReplies",
                column: "CreatorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketReplies_UpdaterId",
                table: "TicketReplies",
                column: "UpdaterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_HasUnreadReplies",
                table: "Tickets",
                column: "HasUnreadReplies");
