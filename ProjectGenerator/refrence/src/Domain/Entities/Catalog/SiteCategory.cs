...
public sealed class SiteCategory : Entity
{
    ...
    [SetsRequiredMembers]
    public SiteCategory(string name, string slug, CategoryScope scope, string? description = null, SiteCategory? parent = null)
    {
        Update(name, slug, description, scope);
        SetParent(parent);
    }

    public void Update(string name, string slug, string? description, CategoryScope scope)
    {
