...
public class TeacherSidebarViewComponent : ViewComponent
{
    public IViewComponentResult Invoke(string? currentArea, string? currentController, string? currentAction)
    {
        ...
        var model = new TeacherSidebarViewModel(
            area,
            currentController,
            currentAction,
            accountName!,
...
public record TeacherSidebarViewModel(
    string? CurrentArea,
