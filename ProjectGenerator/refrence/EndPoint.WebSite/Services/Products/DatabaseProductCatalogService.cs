...
using ProductCommentEntity = Arsis.Domain.Entities.Catalog.ProductComment;
using ProductEntity = Arsis.Domain.Entities.Catalog.Product;

namespace EndPoint.WebSite.Services.Products;
