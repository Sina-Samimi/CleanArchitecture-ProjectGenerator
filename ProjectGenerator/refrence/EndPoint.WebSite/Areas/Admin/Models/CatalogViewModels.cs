...
public sealed class ProductFormSelectionsViewModel
{
    ...
    public IReadOnlyCollection<SelectListItem> TeacherOptions { get; init; }
        = Array.Empty<SelectListItem>();
}
...
public sealed class ProductFormViewModel
{
    ...
    [Display(Name = "شناسه مدرس")]
    [MaxLength(450, ErrorMessage = "شناسه مدرس نمی‌تواند بیش از ۴۵۰ کاراکتر باشد.")]
