...
using LogTableRenameTest.Application.Commands.Identity;
using LogTableRenameTest.Application.Commands.Identity.DeactivateUser;
using LogTableRenameTest.Application.Commands.Identity.DeleteUser;
using LogTableRenameTest.Application.Commands.Identity.RegisterUser;
using LogTableRenameTest.Application.Commands.Identity.UpdateUser;
...
using LogTableRenameTest.Application.Queries.Identity;
using LogTableRenameTest.Application.Queries.Identity.GetUserById;
using LogTableRenameTest.Application.Queries.Identity.GetUsers;
using LogTableRenameTest.Application.Queries.Identity.GetRoles;
