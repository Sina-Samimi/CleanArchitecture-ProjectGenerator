using System.Text;
using LogTableRenameTest.Application;
using LogTableRenameTest.Application.Interfaces;
using LogTableRenameTest.Infrastructure;
using LogTableRenameTest.Infrastructure.Persistence;
using LogTableRenameTest.SharedKernel.Authorization;
using LogTableRenameTest.WebSite.Authorization;
using LogTableRenameTest.WebSite.Extensions;
using LogTableRenameTest.WebSite.Services;
using LogTableRenameTest.WebSite.Services.Cart;
using LogTableRenameTest.WebSite.Services.Blog;
...
try
{
    ...
    var paymentRepo = scope.ServiceProvider.GetService<LogTableRenameTest.Application.Interfaces.IPaymentSettingRepository>();
...
builder.Services.AddSingleton<LogTableRenameTest.Infrastructure.Services.Logging.ApplicationLogSink>();

// Add services to the container.
builder.Services.AddControllersWithViews(options =>
{
    options.Filters.Add<AdminPagePermissionFilter>();
    options.Filters.Add<LogTableRenameTest.WebSite.Filters.SiteNameActionFilter>();
    options.Filters.Add<LogTableRenameTest.WebSite.Filters.VisitTrackingActionFilter>();
    options.Filters.Add<LogTableRenameTest.WebSite.Filters.SeoMetadataActionFilter>();
})
...
builder.Services.AddScoped<LogTableRenameTest.Application.Interfaces.ISMSSenderService, HangfireApplicationSmsSender>();
builder.Services.AddScoped<AdminPagePermissionFilter>();
builder.Services.AddScoped<LogTableRenameTest.WebSite.Filters.SiteNameActionFilter>();
builder.Services.AddScoped<LogTableRenameTest.WebSite.Filters.VisitTrackingActionFilter>();
builder.Services.AddScoped<LogTableRenameTest.WebSite.Filters.SeoMetadataActionFilter>();
builder.Services.AddScoped<LogTableRenameTest.WebSite.Filters.SeoMetadataActionFilter>();
...
builder.Services.AddSingleton<IAuthorizationPolicyProvider, LogTableRenameTest.SharedKernel.Authorization.PermissionPolicyProvider>();
...
builder.Services.AddScoped<IAuthorizationHandler, LogTableRenameTest.SharedKernel.Authorization.PermissionAuthorizationHandler>();
...
{
    options.ServerName = $"LogTableRenameTest-WebSite-Hangfire-{Environment.MachineName}";
});
...
var customSink = app.Services.GetRequiredService<LogTableRenameTest.Infrastructure.Services.Logging.ApplicationLogSink>();
...
app.UseMiddleware<LogTableRenameTest.WebSite.Middleware.MaintenanceModeMiddleware>();
...
app.UseMiddleware<LogTableRenameTest.WebSite.Middleware.SessionValidationMiddleware>();
