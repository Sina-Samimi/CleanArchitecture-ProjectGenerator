...
namespace LogTableRenameTest.WebSite.Extensions;
...
internal static class WebApplicationExtensions
{
    ...
    public static async Task SeedInitialDataAsync(this WebApplication app)
    {
        ...
        try
        {
            ...
            var systemUserId = LogTableRenameTest.Domain.Constants.SystemUsers.AutomationId;
        ...
        try
        {
            ...
            command.CommandText = @"
                IF NOT EXISTS (SELECT * FROM sys.tables t 
                               ...
                               WHERE t.name = 'ApplicationLogs' AND s.name = 'Logs')
                BEGIN
                    -- ایجاد جدول ApplicationLogs
                    ...
                    CREATE INDEX IX_ApplicationLogs_Level ON [Logs].[ApplicationLogs]([Level]);
                    CREATE INDEX IX_ApplicationLogs_CreateDate ON [Logs].[ApplicationLogs]([CreateDate]);
                    CREATE INDEX IX_ApplicationLogs_Level_CreateDate ON [Logs].[ApplicationLogs]([Level], [CreateDate]);
                    CREATE INDEX IX_ApplicationLogs_ApplicationName ON [Logs].[ApplicationLogs]([ApplicationName]);
                    CREATE INDEX IX_ApplicationLogs_SourceContext ON [Logs].[ApplicationLogs]([SourceContext]);
            ...
            logger.LogInformation("ApplicationLogs table check: {Result}", tableResult);
