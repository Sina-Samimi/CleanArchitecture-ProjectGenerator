...
namespace LogTableRenameTest.Infrastructure.Services.Billing;
...
public sealed class SimulatedBankingGatewayService : IBankingGatewayService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var reference = ReferenceGenerator.GenerateReadableReference("PAY", DateTimeOffset.UtcNow);
        var sessionToken = ReferenceGenerator.GenerateShortReference("STS");
    ...
    public Task<Result<BankPaymentReceiptDto>> VerifyPaymentAsync(string reference, CancellationToken cancellationToken)
    {
        ...
        else
        {
            ...
            var trackingCode = ReferenceGenerator.GenerateShortReference("TRX");
