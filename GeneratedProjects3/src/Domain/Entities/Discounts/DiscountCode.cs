...
using LogTableRenameTest.Domain.Interfaces;
using LogTableRenameTest.Domain.ValueObjects;

namespace LogTableRenameTest.Domain.Entities.Discounts;
...
#pragma warning restore IDE0051
    ...
    public sealed record DiscountApplicationResult(
        string Code,
        LogTableRenameTest.Domain.Enums.DiscountType AppliedDiscountType,
        ...
        decimal? EffectiveMaxDiscount)
    {
        ...
        public static DiscountApplicationResult CreateFailure(string message = "Discount application failed")
        {
            return new DiscountApplicationResult(
                string.Empty,
                LogTableRenameTest.Domain.Enums.DiscountType.Percentage,
                0m,
                0m,
                0m,
                null,
