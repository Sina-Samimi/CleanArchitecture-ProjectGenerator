...
public sealed record GetUserNotificationsQuery(string UserId, string? UserRole = null, bool? IsRead = null) : IQuery<NotificationListDto>
{
    public sealed class Handler : IQueryHandler<GetUserNotificationsQuery, NotificationListDto>
    {
        ...
        private readonly Microsoft.AspNetCore.Identity.UserManager<LogTableRenameTest.Domain.Entities.ApplicationUser> _userManager;

        public Handler(INotificationRepository notificationRepository, Microsoft.AspNetCore.Identity.UserManager<LogTableRenameTest.Domain.Entities.ApplicationUser> userManager)
        {
