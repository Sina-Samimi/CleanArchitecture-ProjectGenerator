...
public sealed class InvoiceController : Controller
{
    ...
    public async Task<IActionResult> Cancel(Guid id, CancellationToken cancellationToken)
    {
        ...
        var ownership = await _mediator.Send(new TestAttarClone.Application.Queries.Billing.GetUserInvoiceDetailsQuery(id, user.Id), cancellationToken);
        ...
        var result = await _mediator.Send(new TestAttarClone.Application.Commands.Orders.CancelOrderCommand(id), cancellationToken);
