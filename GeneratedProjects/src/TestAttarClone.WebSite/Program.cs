using System.Text;
using TestAttarClone.Application;
using TestAttarClone.Application.Interfaces;
using TestAttarClone.Infrastructure;
using TestAttarClone.Infrastructure.Persistence;
using TestAttarClone.SharedKernel.Authorization;
using TestAttarClone.WebSite.Authorization;
using TestAttarClone.WebSite.Extensions;
using TestAttarClone.WebSite.Services;
...
using TestAttarClone.WebSite.Services.Session;
...
try
{
    ...
    var paymentRepo = scope.ServiceProvider.GetService<TestAttarClone.Application.Interfaces.IPaymentSettingRepository>();
...
builder.Services.AddSingleton<TestAttarClone.Infrastructure.Services.Logging.AttarApplicationLogSink>();

// Add services to the container.
builder.Services.AddControllersWithViews(options =>
{
    options.Filters.Add<AdminPagePermissionFilter>();
    options.Filters.Add<TestAttarClone.WebSite.Filters.SiteNameActionFilter>();
    options.Filters.Add<TestAttarClone.WebSite.Filters.VisitTrackingActionFilter>();
    options.Filters.Add<TestAttarClone.WebSite.Filters.SeoMetadataActionFilter>();
})
...
builder.Services.AddScoped<TestAttarClone.Application.Interfaces.ISMSSenderService, HangfireApplicationSmsSender>();
builder.Services.AddScoped<AdminPagePermissionFilter>();
builder.Services.AddScoped<TestAttarClone.WebSite.Filters.SiteNameActionFilter>();
builder.Services.AddScoped<TestAttarClone.WebSite.Filters.VisitTrackingActionFilter>();
builder.Services.AddScoped<TestAttarClone.WebSite.Filters.SeoMetadataActionFilter>();
builder.Services.AddScoped<TestAttarClone.WebSite.Filters.SeoMetadataActionFilter>();
...
builder.Services.AddSingleton<IAuthorizationPolicyProvider, TestAttarClone.SharedKernel.Authorization.PermissionPolicyProvider>();
...
builder.Services.AddScoped<IAuthorizationHandler, TestAttarClone.SharedKernel.Authorization.PermissionAuthorizationHandler>();
...
{
    options.ServerName = $"TestAttarClone-WebSite-Hangfire-{Environment.MachineName}";
});
...
var customSink = app.Services.GetRequiredService<TestAttarClone.Infrastructure.Services.Logging.AttarApplicationLogSink>();
...
app.UseMiddleware<TestAttarClone.WebSite.Middleware.MaintenanceModeMiddleware>();
...
app.UseMiddleware<TestAttarClone.WebSite.Middleware.SessionValidationMiddleware>();
